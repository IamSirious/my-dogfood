	...
	return (
		<Container className="mt-4">
			<Card className="border-0">
				<Card.Header className="fs-3 border-0"> в корзине</Card.Header>
				<Card.Body className="text-center">
					...
					<Button className="text-black fw-bold rounded-pill my-2 mx-3" variant="outline-warning">На главную</Button>
				</Card.Body>
			</Card>
		</Container>
	);
